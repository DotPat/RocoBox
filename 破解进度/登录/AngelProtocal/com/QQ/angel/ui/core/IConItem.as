   ...
   public class IConItem extends AImage
   {
      ...
      public function setData(param1:Object) : void
      {
         ...
         else
         {
            ...
            this.tooltip = param1.hasOwnProperty("tooltip") ? String(param1.tooltip) : String(param1.tips);
            this.setPath(param1.hasOwnProperty("src") ? String(param1.src) : String(param1.icon));
         }
      }
